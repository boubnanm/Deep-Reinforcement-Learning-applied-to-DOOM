...
def parse_arguments():
    ...
    parser.add_argument("--max_episode_length", type=int, default=2100, help="Maximum lenght of an episode")
    parser.add_argument("--max_episodes", type=int, default=2000, help="Maximum episodes per worker")
    ...
    parser.add_argument("--freq_model_save", type=int, default=250, help="Frequence of episodes to save model")
